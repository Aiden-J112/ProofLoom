...
When your output names a domain concept, use the term as defined in `CONTEXT.md`. If the concept is not in the glossary yet, reconsider the terminology or note the gap for `/domain-modeling`.
